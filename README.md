...
[![Build Status](https://github.com/co0p/triangleoflove/workflows/CI%20Orchestrator/badge.svg)](https://github.com/co0p/triangleoflove/actions)
...
- [DEPLOYMENT.md](docs/DEPLOYMENT.md): Production deployment model, Railway setup, and required secrets.
